...
public class RecordPlayer extends EntityModel<Entity> {
	...
	public RecordPlayer() {
		...
		record.texOffs(7, 10).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 0.0F, 2.0F, 0.001F, false);
	}
	...
	public void render(RecordPlayerTile tile, MatrixStack matrixStackIn, IVertexBuilder vertexBuffer, int combinedLight, int combinedOverlay, int i, int i1, int i2, int i3) {
	this.renderToBuffer(matrixStackIn, vertexBuffer, combinedLight, combinedOverlay, 1, 1, 1, 1);
	}
}