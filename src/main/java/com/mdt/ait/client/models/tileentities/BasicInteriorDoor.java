...
public class BasicInteriorDoor extends EntityModel<Entity> {
	...
	public BasicInteriorDoor() {
		...
		right_door.texOffs(31, 23).addBox(-14.0F, -30.0F, -1.0F, 14.0F, 56.0F, 1.0F, 0.0F, false);
		right_door.texOffs(0, 0).addBox(-13.0F, -11.5F, -2.0F, 1.0F, 5.0F, 1.0F, 0.0F, false);

		left_door = new ModelRenderer(this);
		left_door.setPos(-14.0F, 6.0F, -16.0F);
		box.addChild(left_door);
		left_door.texOffs(0, 23).addBox(0.0F, -30.0F, -1.0F, 14.0F, 56.0F, 1.0F, 0.0F, false);
		left_door.texOffs(76, 0).addBox(10.0F, -11.0F, -2.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		left_door.texOffs(0, 81).addBox(13.5F, -30.0F, -1.5F, 1.0F, 56.0F, 1.0F, 0.0F, false);
		left_door.texOffs(4, 81).addBox(2.0F, -14.0F, 0.0F, 10.0F, 11.0F, 3.0F, 0.0F, false);

		base = new ModelRenderer(this);
		base.setPos(19.0F, 38.0F, 19.0F);
		box.addChild(base);
		base.texOffs(79, 23).addBox(-5.0F, -70.0F, -37.0F, 4.0F, 64.0F, 4.0F, 0.0F, false);
		base.texOffs(62, 23).addBox(-37.0F, -70.0F, -37.0F, 4.0F, 64.0F, 4.0F, 0.0F, false);
		base.texOffs(0, 13).addBox(-38.0F, -67.0F, -36.0F, 38.0F, 5.0F, 4.0F, 0.0F, false);
		base.texOffs(0, 0).addBox(-36.0F, -67.0F, -38.0F, 34.0F, 5.0F, 7.0F, 0.0F, false);
		base.texOffs(83, 0).addBox(-33.0F, -71.0F, -36.0F, 28.0F, 4.0F, 4.0F, 0.0F, false);

		bb_main = new ModelRenderer(this);
		bb_main.setPos(0.0F, 24.0F, 0.0F);
		bb_main.texOffs(81, 9).addBox(-19.0F, -3.0F, -11.0F, 38.0F, 3.0F, 5.0F, 0.0F, false);
	}
