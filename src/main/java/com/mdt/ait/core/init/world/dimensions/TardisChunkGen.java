...
public class TardisChunkGen extends ChunkGenerator {
    ...
    public static RegistryKey<Biome> biomeRegistryKey = RegistryKey.create(Registry.BIOME_REGISTRY,
        new ResourceLocation(AIT.MOD_ID, "tardis"));
    ...
    public static final Codec<TardisChunkGen> CODEC =
            ...
            RegistryLookupCodec.create(Registry.BIOME_REGISTRY)
                    .xmap(TardisChunkGen::new, TardisChunkGen::getBiomeRegistry)
                    .codec();
    ...
    public TardisChunkGen(MinecraftServer server) {
    ...
    public TardisChunkGen(Registry<Biome> biomes) {
        super(new SingleBiomeProvider(biomes.getOrThrow(TardisChunkGen.biomeRegistryKey)), new DimensionStructuresSettings(false));
        this.biomes = biomes;
    }
