...
public class AITSounds {
    ...
    public static final RegistryObject<SoundEvent> TARDIS_CLOSITER = SOUNDS.register("tardis_cloister", () -> new SoundEvent(
            new ResourceLocation(AIT.MOD_ID, "tardis_cloister")));
